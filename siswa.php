...
<div class="card">
    ...
    <form class="form-inline">
      ...
      <a href="" data-toggle="modal" data-target="#exampleModal" class="btn btn-outline-primary btn-xs"><i style="margin-right=20px "></i> Tambah Data</a> 
      <div class="form-group mx-sm-3 mb-2">
        <label for="inputPassword2" class="sr-only">Password</label>
         <input style="height: 46px" type="text" class="form-control" id="myInput" onkeyup="myFunction()" placeholder="Search for names..">
      </div>
    </form>
