<nav aria-label="breadcrumb">
	<ol class="breadcrumb">
		...
		<li class="breadcrumb-item active" aria-current="page">Tapel</li>
	</ol>
</nav>
<div class="card">
	<div class="card-body">
	...
	//session_destroy();
			...
			if( isset( $_REQUEST['aksi'] )){
				...
				echo '<th width="200"><a href="./admin.php?halaman=tapel_baru" class="btn btn-default btn-xs">Tambah Data</a></th></tr>';
				...
				if( mysqli_num_rows($sql) > 0 ){
					...
					while(list($id,$tapel) = mysqli_fetch_array($sql)){
						echo '<tr><td>'.$no.'</td>';
						echo '<td>'.$tapel.'</td>';
						echo '<td><a href="./admin.php?halaman=tapel_edit&id='.$id.'" class="btn btn-success btn-xs">Edit</a> ';
						echo '<a href="./admin.php?halaman=tapel_hapus&id='.$id.'" class="btn btn-danger btn-xs">Hapus</a></td>';
						echo '</tr>';
						$no++;
					}
				} else {
